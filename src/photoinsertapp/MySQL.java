...
public class MySQL {
    ...
    static
    {
         url="jdbc:sqlserver://127.0.0.1\\SQLExpress;database=AdventureWorks";//You can install and connect your database
         try
         {
    ...
    {
       try(Connection con=DriverManager.getConnection(url,"sa","Your password in SQL Server"))
       {
